...
const Data = [
...

  {
    ...
    fees: "$790",
    description:
      "Angkor Wat represents the entire range of Khmer art from the 9th to the 15th Century. This temple is considered the heart and soul of Cambodia. This place is known for its luxurious stay and adventurous activities. ",
  },

  {
    ...
    fees: "$900",
    description:
      "An immense mausoleum of white marble, built-in Agra by Mughal emperor Shah Jahan in memory of his wife Mumtaz, the monument is breathtakingly beautiful. This place is known for its luxurious stays ands adventurous activities. ",
  },

  {
    ...
    fees: "$500",
    description:
      "Bali is an Indonesian Island and one the best holiday destinations int he Indonesian archipelago. This place is known for its volcanic mountains, history, art & culture, food, temples and beutiful sandy beaches. ",
  },
];
